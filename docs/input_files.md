...
Then run
 ...
 ```
 python3 run.py python.scripts.auto_generate_config -b 'datasets/configs/config_folder/exemplar_config.yaml_template'
 ```
...
```
python3 run.py python.scripts.auto_generate_config -b 'datasets/configs/DuPage_County_IL_potential_configs/example_config.yaml_template'
```
...
in the `.yaml_template` file and then run
```
python3 run.py python.scripts.auto_generate_config -f 'DuPage_County_IL_potential_configs/example_config.yaml_template'
```
### Config fields
