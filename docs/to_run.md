...
```python run.py model_run_db_cli -c4 -l ./Gwinnett_GA_configs/Gwinnett_config_expanded_*.yaml```
...
```python run.py model_run_db_cli -vv -l ./Gwinnett_GA_configs/Gwinnett_config_full_*.yaml```

To run only the full_11 and write log files out to the logs directory:\
```python run.py model_run_db_cli -l ./Gwinnett_GA_configs/Gwinnett_config_full_11.yaml```
