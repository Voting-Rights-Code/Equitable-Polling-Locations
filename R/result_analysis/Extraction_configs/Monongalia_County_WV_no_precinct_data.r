...
COUNTY_PRECINCT_LOCATION_NAME_COL <- NULL #cannnot be null if COUNTY_PROVIDES_PRECINCT_DATA is TRUE
COUNTY_PRECINCT_ADDRESS_COL <- NULL #cannnot be null if COUNTY_PROVIDES_PRECINCT_DATA is TRUE
