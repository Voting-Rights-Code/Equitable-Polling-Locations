...
class TestGetRDHPredictedWholePopulationDemographics(DemographicsTestBase):
    """Unit tests for model_data.get_RDH_predicted_whole_population_demographics using the committed testing fixture."""

    pull_patch_target = 'python.solver.model_data.pull_RDH_predicted_whole_population_data'

    def get_demographics(self, location='testing'):
        return model_data.get_RDH_predicted_whole_population_demographics(location, '2026')
    ...
    def test_missing_file_raises_value_error(self):
        ...
        with patch('python.utils.utils.os.path.isdir', return_value=True), \
             ...
             pytest.raises(ValueError, match='RDH predicted whole population data not found'):
            model_data.get_RDH_predicted_whole_population_demographics('testing', '2026')
    ...
    def test_invalid_projection_year_raises_value_error(self):
        ...
        with pytest.raises(ValueError, match='projection_year'):
            model_data.get_RDH_predicted_whole_population_demographics('testing', '2040')
...
def test_build_distance_data_population_census_type(tmp_path):
    ...
    model_data.build_distance_data(
        'csv',
        census_year='2020',
        census_data_type='predicted_whole_population',
