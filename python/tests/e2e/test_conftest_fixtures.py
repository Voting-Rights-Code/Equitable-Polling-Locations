...
class TestE2eTestDataFiles:
    ...
    def test_all_config_variants_exist(self, e2e_test_data):
        """Each of the 13 CONFIG_VARIANTS must have a corresponding YAML file on disk."""
    ...
    def test_config_variant_count(self, e2e_test_data):
        """Exactly 13 config variants must be created."""
        assert len(e2e_test_data['configs']) == 13
