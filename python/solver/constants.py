...
DISTANCE_ID_ORIG = 'id_orig'
DISTANCE_ID_DEST = 'id_dest'
DISTANCE_SOURCE = 'source'
DISTANCE_DISTANCE_M = 'distance_m'
DISTANCE_ADDRESS = 'address'
DISTANCE_DEST_LAT = 'dest_lat'
DISTANCE_DEST_LON = 'dest_lon'
DISTANCE_ORIG_LAT = 'orig_lat'
DISTANCE_ORIG_LON = 'orig_lon'
DISTANCE_LOCATION_TYPE = 'location_type'
DISTANCE_HISPANIC = 'hispanic'
DISTANCE_NON_HISPANIC = 'non_hispanic'
DISTANCE_WHITE = 'white'
DISTANCE_BLACK = 'black'
DISTANCE_NATIVE = 'native'
DISTANCE_ASIAN = 'asian'
DISTANCE_PACIFIC_ISLANDER = 'pacific_islander'
DISTANCE_OTHER = 'other'
DISTANCE_MULTIPLE_RACES = 'multiple_races'
DISTANCE_TOTAL_POPULATION = 'population'
DISTANCE_WEIGHTED_DIST = 'weighted_dist'
...
DEMOGRAPHICS_OUTPUT_COLUMNS = {
    ...
    DISTANCE_PACIFIC_ISLANDER, DISTANCE_MULTIPLE_RACES, DISTANCE_OTHER,
}
