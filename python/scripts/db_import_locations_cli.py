...
# from python.database.models.distances import LOCATION_TYPE_CITY, LOCATION_TYPE_COUNTY, Distance, DistancesSet
# from models.polling_locations import LOCATION_TYPE_CITY, LOCATION_TYPE_COUNTY, LOCATION_TYPE_CONTAINED_IN_CITY, LOCATION_TYPE_INTERSECTING_CITY, PollingLocation, PollingLocationOnly
# import db
...
#         polling_locations_set = db.create_db_polling_locations_set(state, location_type, location, election_year)
