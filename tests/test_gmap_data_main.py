...
import pandas as pd
from authentication_files.file_path import gmap_csv, census_json,driving_distances
...
def test_main(mocker):
    ...
    mocker.patch('gmap_data_main.get_file_path', return_value=driving_distances)
